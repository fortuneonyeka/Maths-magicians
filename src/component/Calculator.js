  ...
  return (
    ...
    <div className="container">
      ...
      <div className="keypads">
        <button type="button" id="reset" name="AC" onClick={handleClick}>AC</button>
        <button type="button" id="backspace" name="+/-" onClick={handleClick}>+/-</button>
        ...
        <button type="button" className="operator" name="x" onClick={handleClick}>x</button>
        ...
        <button type="button" className="operator" id="plus" name="+" onClick={handleClick}>+</button>
        <button type="button" name="0" className="zero" onClick={handleClick}>0</button>
        <button type="button" name="." onClick={handleClick}>.</button>
        <button type="button" className="operator grid" onClick={handleClick}>=</button>
      </div>
    </div>
